                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="nav-link" href="/stores">Warung</a></li>
                            </ul>
                        </li>
                        @endif
                    </ul>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <td><a
                                                                    href="{{action('StoreController@edit', $store->id)}}"><button
                                                                        class="btn btn-warning float-left mr-3">Edit</button></a>
                                                                <form
                                                                    action="{{action('StoreController@destroy', $store->id)}}"
                                                                    method="post">
                                                                    @csrf
