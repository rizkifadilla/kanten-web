...
<body>
    <center>
        <div class="col-md-6 col-lg-6">
            <form method="POST" action="{{action('MerchantController@update' ,$id)}}" enctype="multipart/form-data" class="mt-5">
                @csrf
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" id="inlineFormInputGroup" name="name"
                                    value="{{$merchants->name}}" required>
                            </div>
                            <div class="input-group mb-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="fas fa-id-card"></i></div>
                                </div>
                                <input type="number" class="form-control" id="inlineFormInputGroup" name="recognizer"
                                    value="{{$merchants->recognizer}}" required>
                            </div>
                        </div>
