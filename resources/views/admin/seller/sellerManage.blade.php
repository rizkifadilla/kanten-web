                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a class="nav-link" href="/merchants">Penjual</a></li>
                                            ...
                                            <div class="container">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>{{$merchant->name}}</td>
                                                            <td>{{$merchant->recognizer}}</td>
                                                            <td>{{$merchant->balance}}</td>
                                                            <td><a
                                                                    href="{{action('MerchantController@edit', $merchant->id)}}"><button
                                                                        class="btn btn-warning float-left mr-3">Edit</button></a>
                                                                <form
                                                                    action="{{action('MerchantController@destroy', $merchant->id)}}"
                                                                    method="post">
                                                                    @csrf
